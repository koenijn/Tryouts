package nl.boomenvanden.tryouts.jbehaveSelenium.acceptance;
...
public class AppleDotComStories extends JUnitStories {
    ...
    StoryReporterBuilder reporterBuilder = new StoryReporterBuilder()
            .withCodeLocation(codeLocationFromClass(AppleDotComStories.class)).withFailureTrace(true)
    ...
    public Configuration configuration() {
        return new SeleniumConfiguration().useSeleniumContext(seleniumContext)
                ...
                .useStoryLoader(new LoadFromClasspath(AppleDotComStories.class))
                .useStoryReporterBuilder(reporterBuilder);
    }

    @Override
    public InjectableStepsFactory stepsFactory() {
        ApplicationContext context = new SpringApplicationContextFactory("apple-steps.xml").createApplicationContext();
